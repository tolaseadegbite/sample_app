...
class MicropostsInterfaceTest < MicropostsInterface
  ...
  test "should dshow errors but not create micropost on invalid submission" do
  ...
  test "should not haave delete linkson other user's profile page" do
...
class MicropostsidebarTest < MicropostsInterface
  ...
  test "should display the right microposts counter" do
    get root_path
...
class ImageUploadTest < MicropostsInterface
  ...
  test "should be able to attach images" do
    cont = "This micropost is lol"
